 ...
 * @author vikas
 */
public class SubDeleteQuery_w_orcl extends javax.swing.JPanel {
...
//            jTabbedPane4.remove(3);
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Sub-Delete Query", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 3, 16))); // NOI18N
...
//            outtertable.setText(table.getSelectedItem().toString());            
            rs=pstmt_field.executeQuery();
            ResultSetMetaData rsmd=rs.getMetaData();
            column_count=rsmd.getColumnCount();
            System.out.println("tablecombo");
            rest_field.removeAllItems();//remove all element before select another table from tablecombo
...
//            pstmt_field=getConn().prepareStatement("Select * from "+schema_name+"."+table_name);
    ...
    private void sub_DelExeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sub_DelExeActionPerformed
        try { 
            //variable for holding query sentence 
            String innerQuery_String="";
            String outterQuery_String="";
            ...
            if(existsBtn.isSelected() || nexistsBtn.isSelected())
            {
                outerQuery="DELETE FROM "+table_full_name+" WHERE "+existsText+" ";
                outterQuery_String="DELETE FROM \n\t"+table_full_name+"\n WHERE \n\t"+existsText+" ";
                System.out.println(outerQuery);
            }           
            else
            {
                outerQuery="DELETE FROM "+table_full_name+" WHERE "+rest_field.getSelectedItem().toString()+" "+oprator.getSelectedItem().toString()+" ";
                outterQuery_String="DELETE FROM \n\t"+table_full_name+"\n WHERE \n\t"+rest_field.getSelectedItem().toString()+" "+oprator.getSelectedItem().toString()+" ";
                System.out.println(outerQuery);
            }
            if(allOrAnyEnable.isSelected())
            {
                ...
                {
                    outerQuery="DELETE FROM "+table_full_name+" WHERE "+rest_field.getSelectedItem().toString()+" "+oprator.getSelectedItem().toString()+" ALL ";
                    outterQuery_String="DELETE FROM \n"+table_full_name+"\n WHERE \n\t"+rest_field.getSelectedItem().toString()+" "+oprator.getSelectedItem().toString()+" ALL ";
                    System.out.println(outerQuery);
                }
                if(anyBtn.isSelected())
                {
                    outerQuery="DELETE FROM "+table_full_name+" WHERE "+rest_field.getSelectedItem().toString()+" "+oprator.getSelectedItem().toString()+" ANY ";
                    outterQuery_String="DELETE FROM \n"+table_full_name+"\n WHERE \n\t"+rest_field.getSelectedItem().toString()+" "+oprator.getSelectedItem().toString()+" ANY ";
                    System.out.println(outerQuery);
                }
            }
            ...
            if((rest_txt_in.getText().equals("")) && (!orderTextArea.getText().equals("")) && !selectGroupBy.isSelected())
            {
                ...
                if(fun_string.equals(""))
                {
                    ...
                    innerQuery_String="\t\t\tSelect \n\t\t\t\t"+selectedfield_data+"\n\t\t\t from \n\t\t\t\t"+table_full_name_in+existsTextCond+"\n\t\t\t ORDER BY \n\t\t\t\t"+orderTextArea.getText();
            ...
            else if((!rest_txt_in.getText().equals("")) && (!orderTextArea.getText().equals("")) && !selectGroupBy.isSelected())
            {
                ...
                if(fun_string.equals(""))
                {
                    ...
                    innerQuery_String="SELECT \n\t\t\t\t"+selectedfield_data+"\n\t\t\t FROM \n\t\t\t\t"+table_full_name_in+" where "+existsTextCond+logic+" ORDER BY "+orderTextArea.getText();
            ...
            else if((!rest_txt_in.getText().equals("")) && (orderTextArea.getText().equals("")) && !selectGroupBy.isSelected())
            {
                ...
                if(fun_string.equals(""))
                {
                    ...
                    innerQuery_String="SELECT \n\t\t\t\t"+selectedfield_data+"\n\t\t\t FROM \n\t\t\t\t"+table_full_name_in+" where "+existsTextCond+logic;
            ...
            else if((rest_txt_in.getText().equals("")) && (!orderTextArea.getText().equals("")) && selectGroupBy.isSelected())
            {
                ...
                if(fun_string.equals(""))
                {
                    ...
                    innerQuery_String="SELECT \n\t\t\t\t"+selectedfield_data+"\n\t\t\t FROM \n\t\t\t\t"+table_full_name_in+existsTextCond+" GROUP BY "+groupByField.getSelectedItem()+" "+havingText+" ORDER BY "+orderTextArea.getText();
            ...
            else if((!rest_txt_in.getText().equals("")) && (!orderTextArea.getText().equals("")) && selectGroupBy.isSelected())
            {
                ...
                if(fun_string.equals(""))
                {
                    ...
                    innerQuery_String="SELECT \n\t\t\t\t"+selectedfield_data+"\n\t\t\t FROM \n\t\t\t\t"+table_full_name_in+existsTextCond+logic+" GROUP BY "+groupByField.getSelectedItem()+" "+havingText+" ORDER BY "+orderTextArea.getText();
            ...
            else if((!rest_txt_in.getText().equals("")) && (orderTextArea.getText().equals("")) && selectGroupBy.isSelected())
            {
                ...
                if(fun_string.equals(""))
                {
                    ...
                    innerQuery_String="SELECT \n\t\t\t\t"+selectedfield_data+"\n\t\t\t FROM \n\t\t\t\t"+table_full_name_in+existsTextCond+logic+" GROUP BY "+groupByField.getSelectedItem()+" "+havingText;                   
            ...
            else if((rest_txt_in.getText().equals("")) && (orderTextArea.getText().equals("")) && selectGroupBy.isSelected())
            {
                ...
                if(fun_string.equals(""))
                {
                    ...
                    innerQuery_String="SELECT \n\t\t\t\t"+selectedfield_data+"\n\t\t\t FROM \n\t\t\t\t"+table_full_name_in+existsTextCond+" GROUP BY "+groupByField.getSelectedItem()+" "+havingText;                   
            ...
            else
            {
                if(existsBtn.isSelected() || nexistsBtn.isSelected())
                {
                    existsTextCond="\n\t\t\t WHERE \n\t\t\t\t"+existsTextCond.substring(0, existsTextCond.length()-5);
                }                
                if(fun_string.equals(""))
                {
            ...
            if(i==1)
            {
                QBPanel1.playSound("D:\\MyProject\\Adv QB\\QueryBuilder3\\src\\Audio\\subrowdelete.wav");
                JOptionPane.showMessageDialog(null, " row is deleted . . .");
//                err_msg.setText(" row is deleted . . .");
                QBPanel1.setQueryString(outterQuery_String+"\n\t\t(\n\t\t\t"+innerQuery_String+"\n\t\t)");
            }
            else
            {
