...
import querybuilder.AttachPanel1;
import querybuilder.DatePanel1;
import querybuilder.QBPanel1;
import querybuilder.StartWindow;
import querybuilder.TextPanel;
import static querybuilder.subquery.SubSelectQuery_w_orcl.getConn;

/**
 *
 * @author vikas
 */
public class SubUpdateQuery_w_orcl extends javax.swing.JPanel {
...
//            jTabbedPane4.remove(3);
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Sub-Update Query", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 3, 16))); // NOI18N
        ...
        jPanel14.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Where Clause", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 3, 14), new java.awt.Color(204, 204, 255))); // NOI18N
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                .addGap(22, 22, 22)
                .addComponent(schema, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(table, javax.swing.GroupLayout.PREFERRED_SIZE, 213, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(53, 53, 53))
            .addGroup(jPanel8Layout.createSequentialGroup()
                .addGap(65, 65, 65)
    ...
    private void andBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_andBtnActionPerformed
        ...
        try 
        {
                if(rsmd.getColumnTypeName(rest_field_in.getSelectedIndex()+1).equals("VARCHAR") || rsmd.getColumnTypeName(rest_field_in.getSelectedIndex()+1).equals("VARCHAR2"))
                {
...
//            pstmt_field=getConn().prepareStatement("Select * from "+schema_name+"."+table_name);
    ...
    private void sub_DelExeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sub_DelExeActionPerformed
        try {
            ...
            if(existsBtn.isSelected() || nexistsBtn.isSelected())
            {
                outerQuery="Update "+table_full_name+" SET "+setvalue+" where "+existsText+" ";
                System.out.println(outerQuery);
            }
            else
            {
                outerQuery="Update "+table_full_name+" SET "+setvalue+" where "+rest_field.getSelectedItem().toString()+" "+oprator.getSelectedItem().toString()+" ";
                System.out.println(outerQuery);
            }
            if(allOrAnyEnable.isSelected())
            {
                ...
                {
                    outerQuery="Update "+table_full_name+" SET "+setvalue+" where "+rest_field.getSelectedItem().toString()+" "+oprator.getSelectedItem().toString()+" ALL ";
                    System.out.println(outerQuery);
                }
                if(anyBtn.isSelected())
                {
                    outerQuery="Update "+table_full_name+" SET "+setvalue+" where "+rest_field.getSelectedItem().toString()+" "+oprator.getSelectedItem().toString()+" ANY ";
                    System.out.println(outerQuery);
                }
            }
            ...
            if(i==1)
            {
                QBPanel1.playSound("D:\\MyProject\\Adv QB\\QueryBuilder3\\src\\Audio\\subrowupdate.wav");
                JOptionPane.showMessageDialog(null, " row is updated . . .");
//                err_msg.setText(" row is Uptate . . .");
